    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            ...
            if($_REQUEST['dari_tanggal'] == "" || $_REQUEST['sampai_tanggal'] == ""){
                ...
                $query = mysqli_query($config, "SELECT * FROM tbl_form_kesehatan WHERE tgl_surat BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
                ...
                echo '
                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Laporan Form Kesehatan<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                    ...
                    <div class="row agenda">
                        <div class="disp hidd">';
                            ...
                            <h5 class="hid">Laporan Form Kesehatan</h5>
                        <div class="col s10">
                            <p class="warna agenda">Laporan Form Kesehatan dari tanggal <strong>'.indoDate($dari_tanggal).'</strong> sampai dengan tanggal <strong>'.indoDate($sampai_tanggal).'</strong></p>
                        </div>
                        <div class="col s2">
                            ...
                            if(mysqli_num_rows($query) > 0){
                                ...
                                while($row = mysqli_fetch_array($query)){
                                 echo '
                                    ...
                                    echo '<tr><td colspan="9"><center><p class="add">Tidak ada Laporan Form Kesehatan</p></center></td></tr>';
                                } echo '
                            </tbody></table>
                        </div>
