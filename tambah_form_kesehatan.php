    ...
    if(empty($_SESSION['admin'])){
        ...
        if(isset($_REQUEST['submit'])){
            if( $_REQUEST['nama_istri'] == "" || $_REQUEST['umur_istri'] == "" || $_REQUEST['pekerjaan_istri'] == "" || $_REQUEST['alamat_istri'] == "" || $_REQUEST['bb_istri'] == "" || $_REQUEST['tb_istri'] == "" || $_REQUEST['lila_istri'] == "" || $_REQUEST['td_istri'] == "" || 
                ...
                $cek = mysqli_query($config, "SELECT * FROM tbl_form_kesehatan WHERE no_surat='$no_surat'");
                $result = mysqli_num_rows($cek);

                if($result > 0){
                    echo "<script>alert('Nomor surat sudah terpakai!, gunakan yang lain! ');
                    window.location.href ='./admin.php?page=tsk&act=add';</script>";
                } else {
                  $query = mysqli_query($config, "INSERT INTO tbl_form_kesehatan(id_user,no_surat,nama_istri,umur_istri,pekerjaan_istri,alamat_istri,bb_istri,tb_istri,lila_istri,td_istri,hb_istri,darah_istri,nama_suami,umur_suami,pekerjaan_suami,alamat_suami,bb_suami,tb_suami,td_suami,hb_suami,darah_suami,screening_imunisasi,tindakan,pernyataan,pelaksana,tgl_surat,status)
                  VALUES('$id_user','$no_surat','$nama_istri','$umur_istri','$pekerjaan_istri','$alamat_istri','$bb_istri','$tb_istri','$lila_istri','$td_istri','$hb_istri','$darah_istri','$nama_suami','$umur_suami','$pekerjaan_suami','$alamat_suami','$bb_suami','$tb_suami','$td_suami','$hb_suami','$darah_suami','$screening_imunisasi','$tindakan','$pernyataan','$pelaksana','$tgl_surat','T')");
                // echo var_dump($query);
                // die();
                if($query == true){
        ...
        ?>
                ...
                <div class="col s12">
                    <nav class="secondary-nav">
                        <div class="nav-wrapper blue-grey darken-1">
                            <ul class="left">
                                <li class="waves-effect waves-light"><a href="?page=tsk&act=add" class="judul"><i class="material-icons">drafts</i> Tambah Data Form Kesehatan</a></li>
                            </ul>
                        </div>
                    </nav>
                </div>
            ...
            <div class="row jarak-form">
                ...
                <form class="col s12" method="POST" action="?page=tsk&act=add" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="umur_istri" type="text" class="validate" name="umur_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="pekerjaan_istri" type="text" class="validate" name="pekerjaan_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="alamat_istri" type="text" class="validate" name="alamat_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="bb_istri" type="text" class="validate" name="bb_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="tb_istri" type="text" class="validate" name="tb_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="lila_istri" type="text" class="validate" name="lila_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="td_istri" type="text" class="validate" name="td_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="hb_istri" type="text" class="validate" name="hb_istri" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="darah_istri" type="text" class="validate" name="darah_istri" required>
                                <?php
                ...
                <h3>Form Kesehatan Calon Suami</h3>
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">alarm</i>
                            <input id="umur_suami" type="text" class="validate" name="umur_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">work</i>
                            <input id="pekerjaan_suami" type="text" class="validate" name="pekerjaan_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">place</i>
                            <input id="alamat_suami" type="text" class="validate" name="alamat_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="bb_suami" type="text" class="validate" name="bb_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="tb_suami" type="text" class="validate" name="tb_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="td_suami" type="text" class="validate" name="td_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="hb_suami" type="text" class="validate" name="hb_suami" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="darah_suami" type="text" class="validate" name="darah_suami" required>
                                <?php
                ...
                <div class="input-field col s6">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="screening_imunisasi" type="text" class="validate" name="screening_imunisasi" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="tindakan" type="text" class="validate" name="tindakan" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="pernyataan" type="text" class="validate" name="pernyataan" required>
                                <?php
                        ...
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">person</i>
                            <input id="pelaksana" type="text" class="validate" name="pelaksana" required>
                                <?php
